...
class ExecutionStep(BaseModel):
    ...
    agent_role: str = Field(..., description="Role name of the target agent")
    description: str = Field(default="", description="Target objective of this step")


class ExecutionPlan(BaseModel):
    """Workflow plan generated by the Supervisor outlining the sequential agents to execute."""
